...
namespace Case.Core.Utils
{
    public static class BookUtils
    {
        ...
        public static BookCatalogItem BookToCatalogItemModel(Book book)
        {
        ...
        public static bool VerifyIsbn(string isbn)
        {
            ...
            if (string.IsNullOrEmpty(isbn)) return result;
        ...
        public static bool VerifyIsbn(BookCopy bookCopy)
        {
            return bookCopy != null && VerifyIsbn(bookCopy.Isbn);
        }
#endregion
        #region Isbn validation implementation
        private static bool IsValidIsbn10(string isbn10)
        {
            bool result = false;
            if (string.IsNullOrEmpty(isbn10)) return result;
